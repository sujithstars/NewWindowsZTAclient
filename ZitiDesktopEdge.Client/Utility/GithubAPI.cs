...
namespace ZitiDesktopEdge.Utility {
    public static class GithubAPI {
		...
		public const string ProdUrl = "https://api.github.com/repos/IntrusionINTZ/windows-zta-client/releases/latest";
		public const string BetaUrl = "https://api.github.com/repos/openziti/desktop-edge-win-beta/releases/latest";
		public const string ProdReleasesUrl = "https://api.github.com/repos/IntrusionINTZ/windows-zta-client/releases";
