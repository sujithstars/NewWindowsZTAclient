...
## What's New
* Identities can now be added via Azure Active Directory

## Other changes:
* 'Detach App' option in main menu removed
* 'Quit Intrusion Desktop Shield' text in main menu changed to 'Quit Shield Endpoint'
* The dialog box text notifying of a config saved was changed
* App's name in Windows changed to 'Shield Endpoint'
* Uptime timer moved to top of window
* Download Speed and Upload Speed measurements removed
* 'Click to Connect' and 'Click to Disconnect' text added
